...
export const ShowcaseSlider = () => {
  ...
  return (
    <div className='hidden h-screen w-full lg:mx-auto  lg:block lg:w-5/12'>
      ...
      >
        <div className='mx-auto w-11/12 max-w-xl justify-between rounded-lg bg-[rgba(255,255,255,.5)] p-4 shadow-lg backdrop-blur-md hover:scale-[1.01] hover:shadow-2xl dark:bg-[rgba(0,0,0,.5)] md:w-8/12 md:p-8 md:px-8 md:py-8 lg:w-11/12 2xl:w-9/12'>
