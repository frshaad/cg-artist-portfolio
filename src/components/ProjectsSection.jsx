...
export const ProjectsSection = () => {
  ...
  return (
    <section className='relative mb-24 w-screen bg-gray-50 dark:bg-black md:mb-0 md:h-screen lg:flex lg:items-center'>
      <div className='m-auto flex w-11/12 flex-col items-center justify-center lg:flex-row'>
        ...
        <div className='relative mx-auto flex h-fit w-full flex-col rounded-xl bg-[rgb(255,255,255,0.5)] px-10 py-4 capitalize shadow-2xl drop-shadow-2xl backdrop-blur-md md:-top-16 md:w-2/3 lg:top-0  lg:right-24  lg:w-1/2 lg:p-10 xl:w-5/12 2xl:w-3/12'>
          <ProjectsTitle />
          <div className='py-2'>
            <h6>Project</h6>
