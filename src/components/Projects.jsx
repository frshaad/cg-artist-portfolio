...
export const Projects = () => {
  ...
  return (
    <section className='h-screen w-screen snap-start bg-gray-50 dark:bg-black'>
      <article
        className='flex h-full w-full flex-col justify-between bg-cover bg-center bg-no-repeat py-14 px-10 brightness-95 saturate-[0.8] dark:brightness-90 lg:px-44 lg:py-36'
      ...
      >
        ...
        <div className='flex items-center justify-between '>
          <div className='flex flex-col gap-3 lg:gap-5'>
            <p className='text-3xl font-bold capitalize text-gray-900 lg:text-5xl'>
              {projects[activeProject].name}
            </p>
            <p className='mb-10 text-lg capitalize text-gray-800 lg:text-xl'>
